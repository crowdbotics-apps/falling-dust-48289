"""
Django settings for falling_dust_48289 project.
...
ROOT_URLCONF = 'falling_dust_48289.urls'
...
WSGI_APPLICATION = 'falling_dust_48289.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_dust_48289 API",
    "DESCRIPTION": "API documentation for falling_dust_48289 App",
    "VERSION": "v1",
}
